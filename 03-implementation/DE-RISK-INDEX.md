...
Artifacts: `edge-negotiator/src/run_metrics_sweep.py`, `edge-negotiator/results/coord_throughput.md`. ⚠️ Ran thin (2 seeds, end=200 — under-delivered; rerun with the real SLM + more seeds).
