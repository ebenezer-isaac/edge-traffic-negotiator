...
identical thirty disjoint seeds. The oversaturated cells are retained, so
the comparison is a controlled manipulation of demand rather than a
replacement of inconvenient data.
