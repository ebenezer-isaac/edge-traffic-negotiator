...
{\sffamily\large Verified-Source Cross-Junction Coordination for SLM-Driven Traffic Signal Control}\\[5pt]
{\small\color{nbgrey} Progress report \quad$\vert$\quad UCL MSc Systems Engineering for IoT (25153651) \quad$\vert$\quad Supervisors: Dr A.\ Delibasi (UCL), L.\ Stott (Microsoft) \quad$\vert$\quad 2026-06-20}
\end{center}
\vspace{2pt}
...
\end{axis}
\end{tikzpicture}\\[2pt]
{\scriptsize\color{nbgrey} SUMO\,$^{[4]}$, 30 paired runs. Gains (blue) vs the no-defence baselines; cost (red) vs blindly trusting. Every 95\% range excludes zero.}
\end{minipage}
...
\vspace{2pt}
{\footnotesize \textbf{Claim:} authenticated messaging between junctions; detection of faked or faulty reports with a measured reliability curve; a deterministic safety floor; a fair attack-and-defence comparison.\\[3pt]
